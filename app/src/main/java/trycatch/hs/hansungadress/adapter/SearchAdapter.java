...
public class SearchAdapter extends BaseAdapter {
    ...
    public SearchAdapter(Context mContext, ArrayList<AddressModel> items) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        if(item.isFavorite())
            ...
            Glide.with(mContext).load(R.drawable.favorite_off).into(viewHolder.search_item_favorite);
